...
public class PcKeystroak {
    ...
    static {
        ...
        MAP.put(5, Keystroke.BRAIL_KEY_2); // KEY 8
        MAP.put(2, Keystroke.BRAIL_KEY_3); // KEY 4
        MAP.put(9, Keystroke.BRAIL_KEY_4); // KEY 4
        MAP.put(6, Keystroke.BRAIL_KEY_5); // KEY 1
